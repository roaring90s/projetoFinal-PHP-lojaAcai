...
<head>
    ...
    <!--ÍCONES DO BOOTSTRAP-->
    <link rel="icon" href="/img/berry.png" type="image/x-icon" /> <!--ÍCONE DA PÁGINA-->
...
<body>
    ...
    <main class="flex-fill">
        <div class="container">
            ...
            <p>A sua privacidade é importante para nós. É política do Rochedo Açaís respeitar a sua privacidade em
                relação a qualquer informação sua que possamos coletar no site <a href=http://www.dominio.com>Rochedo
                    Açaís</a>, e outros sites que possuímos e operamos.</p>
            ...
            <h2>Política de Cookies Rochedo Açaís</h2>
            ...
            <p>Como é prática comum em quase todos os sites profissionais, este site usa cookies, que são pequenos
                ...
                compartilharemos como você pode impedir que esses cookies sejam armazenados, no entanto, isso
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Rochedo Açaís oferece no
            ...
            <ul>
                ...
                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Rochedo Açaís, de seus
